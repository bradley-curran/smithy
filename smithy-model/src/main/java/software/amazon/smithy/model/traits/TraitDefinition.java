...
public final class TraitDefinition extends AbstractTrait implements ToSmithyBuilder<TraitDefinition> {
     ...
     */
    public static final class DiffRule implements ToNode {
        private final NodePointer path;
        private final Severity severity;
        private final ChangeType change;
        private final String message;

        public DiffRule(NodePointer path, Severity severity, ChangeType change, String message) {
            this.path = path;
        ...
        public boolean equals(Object obj) {
            if (obj instanceof DiffRule) {
                DiffRule other = (DiffRule) obj;
         ...
         */
        public static DiffRule fromNode(Node node) {
            ...
            return new DiffRule(path, severity, change, message);
        }
    }
    ...
    private final List<DiffRule> breakingChanges;
     ...
     */
    public List<DiffRule> getBreakingChanges() {
    ...
    public static final class Builder extends AbstractTraitBuilder<TraitDefinition, Builder> {
        ...
        private final BuilderRef<List<DiffRule>> breakingChanges = BuilderRef.forList();
        ...
        public Builder breakingChanges(List<DiffRule> diff) {
        ...
        public Builder addBreakingChange(DiffRule rule) {
        ...
        public TraitDefinition createTrait(ShapeId target, Node value) {
            ...
            members.getArrayMember("breakingChanges").ifPresent(d -> {
                for (ObjectNode entry : d.getElementsAs(ObjectNode.class)) {
                    builder.addBreakingChange(DiffRule.fromNode(entry));
                }
            });
