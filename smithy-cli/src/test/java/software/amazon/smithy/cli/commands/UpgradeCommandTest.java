...
public class UpgradeCommandTest {
    ...
    public void testUpgrade(Path initialPath, String name) {
        ...
        String actual = new UpgradeCommand().upgradeFile(model, initialPath);
        String expected = IoUtils.readUtf8File(expectedPath);
        assertThat(actual, equalTo(expected));
    }

    public static Stream<Arguments> source() throws Exception {
        Path start = Paths.get(UpgradeCommandTest.class.getResource("upgrade/cases").toURI());
    ...
    public void testUpgradeDirectory() throws Exception {
        Path baseDir = Paths.get(UpgradeCommandTest.class.getResource(
